...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        if self.ConvertVideo is None:
            ...
            widgets.list_mode.clicked.connect(lambda: self.ConvertVideo.selectMode(widgets.list_mode.currentItem().text(), "modeBox"))
            widgets.list_video_type.clicked.connect(lambda: self.ConvertVideo.selectMode(widgets.list_video_type.currentItem().text(), "typeBox"))
